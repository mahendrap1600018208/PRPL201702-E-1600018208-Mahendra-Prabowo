    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold active"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Menu Makanan Dan Minuman </a>
            </li>
                <li class="no-padding">
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Menu Makanan Dan Minuman </h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption">Tambah, Ubah Atau Hapus Menu Makanan.</p>
		  ...
		  <form class="formValidate" id="formValidate1" method="post" action="routers/add-item.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Tambah Item Menu</h4>
              </div>
              <div>
<table>
                    <thead>
                      <tr>
                        ...
                        <th data-field="name">Harga Satuan/Satuan</th>
                      </tr>
                    </thead>
