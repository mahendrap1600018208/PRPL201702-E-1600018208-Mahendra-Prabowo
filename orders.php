    ...
    <div class="wrapper">
      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Pesan Makanan Dan Minuman </a>
            </li>
                <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan active"><i class="mdi-editor-insert-invitation"></i> Pesanan </a>
                            <div class="collapsible-body">
								...
								if(!isset($_GET['status'])){
									...
									"><a href="orders.php">Semua Pesanan </a>
                                </li>
								<?php
      ...
      <section id="content">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title"> Riwayat pesanan Anda </h5>
              </div>
            </div>
          </div>
        </div>
        ...
        <!--start container-->
        <div class="container">
          <p class="caption"> Rincian Riwayat Pesanan Anda </p>
                ...
                <div>
					...
					while($row = mysqli_fetch_array($sql))
					{
						...
						echo '<li class="collection-item avatar">
                              ...
                              <p><strong>Jenis pembayaran :</strong> '.$row['payment_type'].'</p>
						...
						while($row1 = mysqli_fetch_array($sql1))
						{
                            ...
                            <div class="col s2">
                            <span>'.$row1['quantity'].' Satuan</span>
                            </div>
                            <div class="col s3">
                            <span>IDR. '.$row1['price'].'</span>
                            </div>
                            </div>
                            </li>';
							$id = $row1['order_id'];
								...
								echo'<li class="collection-item">
                                        <div class="row">
                                            ...
                                            <div class="col s3">
                                                <span><strong>IDR. '.$row['total'].'</strong></span>
                                            </div>';
